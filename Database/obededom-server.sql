...
INSERT INTO `comfort_propiedad` VALUES (1,3,1),(2,3,4),(3,3,7);
...
INSERT INTO `garage` VALUES (1,1),(2,2),(3,3),(5,4);
...
INSERT INTO `plantas` VALUES (1,1),(2,2),(3,3),(4,4);
...
INSERT INTO `propiedad_sobre` VALUES (1,'No Aplica'),(2,'Rambla'),(3,'Avenida');
...
INSERT INTO `propiedades` VALUES (1,'Monoambiente totalmente equipado en Buceo.','Alquiler',19000,0,1,'Apartamento','10','Palermo','M54, S12',2003,2,1,1,'Buen Estado',1,0,'1','2','3','2',25,2,30,3,'no','DESPOSITO EN BHU, SURA Y CGN','OBED-EDOM Alquila Monoambiente totalmente Equipado.',0,0,0),(2,'Propiedad Ejemplo','Venta',150000,1,0,'Casa','2','El Pinar','18 de Julio',2015,1,0,2,'Reciclada',1,0,'1','1','2','3',45,30,10,2,'','<p>Ejemplo Garant&iacute;a</p>','<p>Ejemplo Descripci&oacute;n</p>',1,0,0),(3,'fasf','Venta',4124,0,0,'Casa','4','Artilleros','Bulevar Artigas 1913 esq. Goes',1254,3,2,2,'Reciclada',0,0,'Inferior','E','Avenida','1km',12,12,12,1,'asd','<p>asd</p>','<p>asd</p>',1,1,1);
...
INSERT INTO `seguridad_propiedad` VALUES (1,3,1),(2,3,4);
...
BEGIN
	 update propiedades set activo = estado where id_propiedad = idprop;
END ;;
DELIMITER ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `EliminarBanios`(IN id INT)
BEGIN
	DELETE FROM banio WHERE id_baños = id;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `EliminarComfort`(IN id INT)
BEGIN
...
BEGIN
	insert into Banio(cantidad_baños)value(cant);
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
BEGIN
	insert into propiedad_sobre(propiedad_sobre)value(sobre);
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `Login`(IN usu varchar(50),IN contra LONGTEXT)
BEGIN
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `ModificarPropiedad` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `ModificarPropiedad`(IN idprop INT, IN title varchar(100),IN tipo_op VARCHAR(200),IN precio INT,IN perm INT,IN fin INT,IN tipo_prop VARCHAR(200),IN dep VARCHAR(200),IN loc VARCHAR(200),IN direcc VARCHAR(200), IN año INT,IN dorm INT,IN baño INT,IN garag INT,IN state VARCHAR(200),IN ofi INT,IN vivi_social INT,IN dispo VARCHAR(200),IN orient VARCHAR(200),IN sob VARCHAR(200),IN dis_mar VARCHAR(200),IN metros_edif INT,IN metros_terraz INT,IN mts_terreno INT,IN plant INT,IN extr varchar(200),IN garanti LONGTEXT,IN desc_prop LONGTEXT, IN act INT, IN vistamar INT, IN mostprecio INT)
BEGIN
	UPDATE propiedades set titulo = title, tipo_operacion = tipo_op, Precio_Venta = precio, Permuta = perm, Financia = fin, tipo_propiedad = tipo_prop, departamento = dep, localidad = loc, direccion = direcc, año_construccion = año, dormitorios = dorm, baños = baño, garage = garag, estado = state, oficina = ofi, vivienda_social = vivi_social, disposicion = dispo, orientacion = orient, sobre = sob, distancia_mar = dis_mar, metros_edificados = metros_edif, metros_terraza = metros_terraz, metros_terreno = mts_terreno, plantas = plant, extras = extr, garantias = garanti, descripcion_propiedad = desc_prop, activo = act, vista_mar = vistamar, mostrar_precio = mostprecio where id_propiedad = idprop;
	SELECT LAST_INSERT_ID() as id;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `TraigoMensajes`()
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `TraigoPropiedades`()
BEGIN
...
-- Dump completed on 2021-10-13 15:22:23
