...
DELIMITER ;;
CREATE DEFINER=`obededom`@`localhost` PROCEDURE `CambiarEstado`(IN idprop INT, IN estado INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`obededom`@`localhost` PROCEDURE `EliminarBanios`(IN id INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`obededom`@`localhost` PROCEDURE `EliminarComfort`(IN id INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`obededom`@`localhost` PROCEDURE `EliminarComfortPropiedad`(IN id INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`obededom`@`localhost` PROCEDURE `EliminarDistanciaMar`(IN id INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`obededom`@`localhost` PROCEDURE `EliminarDormitorios`(IN id INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`obededom`@`localhost` PROCEDURE `EliminarEstados`(IN id INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`obededom`@`localhost` PROCEDURE `EliminarGarage`(IN id INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`obededom`@`localhost` PROCEDURE `EliminarLocalidad`(IN id INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`obededom`@`localhost` PROCEDURE `EliminarMensajes`(IN id INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`obededom`@`localhost` PROCEDURE `EliminarPlantas`(IN id INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`obededom`@`localhost` PROCEDURE `EliminarPropiedad`(IN id INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`obededom`@`localhost` PROCEDURE `EliminarSeguridad`(IN id INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`obededom`@`localhost` PROCEDURE `EliminarSeguridadPropiedad`(IN id INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`obededom`@`localhost` PROCEDURE `EliminarSobre`(IN id INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`obededom`@`localhost` PROCEDURE `EliminarTipoOperacion`(IN id INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`obededom`@`localhost` PROCEDURE `EliminarTipoPropiedad`(IN id INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`obededom`@`localhost` PROCEDURE `InsertBanios`(IN cant INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`obededom`@`localhost` PROCEDURE `InsertComfort`(IN tipo VARCHAR(100))
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`obededom`@`localhost` PROCEDURE `InsertComfortPropiedad`(IN idprop INT, IN idcomfort INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`obededom`@`localhost` PROCEDURE `InsertDistanciaMar`(IN dist VARCHAR(100))
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`obededom`@`localhost` PROCEDURE `InsertDormitorio`(IN cant INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`obededom`@`localhost` PROCEDURE `InsertEstado`(IN estado VARCHAR(100))
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`obededom`@`localhost` PROCEDURE `InsertGarage`(IN cant INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`obededom`@`localhost` PROCEDURE `InsertImagen`(IN idprop INT, IN foto VARCHAR(300))
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`obededom`@`localhost` PROCEDURE `InsertLocalidad`(IN iddepart INT, IN localidad VARCHAR(60))
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`obededom`@`localhost` PROCEDURE `InsertMensaje`(IN cont INT, IN tipo INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`obededom`@`localhost` PROCEDURE `InsertPlantas`(IN cant INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`obededom`@`localhost` PROCEDURE `InsertSeguridad`(IN tipo VARCHAR(100))
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`obededom`@`localhost` PROCEDURE `InsertSeguridadPropiedad`(IN idprop INT, IN idseguridad INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`obededom`@`localhost` PROCEDURE `InsertSobre`(IN sobre VARCHAR(60))
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`obededom`@`localhost` PROCEDURE `InsertTipoPropiedad`(IN tipoprop VARCHAR(60))
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`obededom`@`localhost` PROCEDURE `Login`(IN usu varchar(50),IN contra LONGTEXT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`obededom`@`localhost` PROCEDURE `TraigoBaños`()
BEGIN
	Select * from banio;
END ;;
DELIMITER ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`obededom`@`localhost` PROCEDURE `TraigoComfort`()
BEGIN
	Select * from comfort;
END ;;
DELIMITER ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`obededom`@`localhost` PROCEDURE `TraigoComfortPropiedad`(IN prop_id int)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`obededom`@`localhost` PROCEDURE `TraigoDepartamentos`()
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`obededom`@`localhost` PROCEDURE `TraigoDistanciaMar`()
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`obededom`@`localhost` PROCEDURE `TraigoDormitorios`()
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`obededom`@`localhost` PROCEDURE `TraigoEstados`()
BEGIN
	Select * from estados;
END ;;
DELIMITER ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`obededom`@`localhost` PROCEDURE `TraigoGarage`()
BEGIN
	Select * from garage;
END ;;
DELIMITER ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`obededom`@`localhost` PROCEDURE `TraigoImagenes`(IN prop_id int)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`obededom`@`localhost` PROCEDURE `TraigoLocalidad`(IN Dep int)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`obededom`@`localhost` PROCEDURE `TraigoMensajes`()
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`obededom`@`localhost` PROCEDURE `TraigoPlantas`()
BEGIN
	Select * from plantas;
END ;;
DELIMITER ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`obededom`@`localhost` PROCEDURE `TraigoPropiedad`(IN prop int)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`obededom`@`localhost` PROCEDURE `TraigoPropiedades`()
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`obededom`@`localhost` PROCEDURE `TraigoPropiedadFiltro`(IN tipoop INT, IN tipoprop INT, IN dep INT, IN localid INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`obededom`@`localhost` PROCEDURE `TraigoSeguridad`()
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`obededom`@`localhost` PROCEDURE `TraigoSeguridadPropiedad`(IN prop_id int)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`obededom`@`localhost` PROCEDURE `TraigoSobre`()
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`obededom`@`localhost` PROCEDURE `TraigoTipoOperacion`()
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`obededom`@`localhost` PROCEDURE `TraigoTipoPropiedad`()
BEGIN
...
-- Dump completed on 2021-10-08  8:50:50
