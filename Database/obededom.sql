...
CREATE TABLE `localidades` (
  ...
  `nombre_localidad` varchar(100) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=1655 DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `propiedades` (
  ...
  `tipo_operacion` varchar(200) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
  `Precio_Venta` int NOT NULL,
  `Permuta` int NOT NULL,
  `Financia` int NOT NULL,
  `tipo_propiedad` varchar(200) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
  `departamento` varchar(200) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
  `localidad` varchar(200) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
  `direccion` varchar(200) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
  `año_construccion` int NOT NULL,
  `dormitorios` int NOT NULL,
  `baños` int NOT NULL,
  `garage` int NOT NULL,
  `estado` varchar(200) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
  `oficina` int NOT NULL,
  `vivienda_social` int NOT NULL,
  `disposicion` varchar(200) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
  `orientacion` varchar(200) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
  `sobre` varchar(200) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
  `distancia_mar` varchar(200) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
  `metros_edificados` int NOT NULL,
  `metros_terraza` int NOT NULL,
  `metros_terreno` int NOT NULL,
  `plantas` int NOT NULL,
  `extras` varchar(200) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
...
CREATE TABLE `usuarios` (
  ...
  `pass` longtext CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
...
INSERT INTO `usuarios` VALUES (1,'obededom','giovanna2021*');
...
DELIMITER ;;
CREATE DEFINER=`cpses_obkuweycr7`@`localhost` PROCEDURE `CambiarEstado`(IN idprop INT, IN estado INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`cpses_obkuweycr7`@`localhost` PROCEDURE `EliminarBanios`(IN id INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`cpses_obkuweycr7`@`localhost` PROCEDURE `EliminarComfort`(IN id INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`cpses_obkuweycr7`@`localhost` PROCEDURE `EliminarComfortPropiedad`(IN id INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`cpses_obkuweycr7`@`localhost` PROCEDURE `EliminarDistanciaMar`(IN id INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`cpses_obkuweycr7`@`localhost` PROCEDURE `EliminarDormitorios`(IN id INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`cpses_obkuweycr7`@`localhost` PROCEDURE `EliminarEstados`(IN id INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`cpses_obkuweycr7`@`localhost` PROCEDURE `EliminarGarage`(IN id INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`cpses_obkuweycr7`@`localhost` PROCEDURE `EliminarLocalidad`(IN id INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`cpses_obkuweycr7`@`localhost` PROCEDURE `EliminarMensajes`(IN id INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`cpses_obkuweycr7`@`localhost` PROCEDURE `EliminarPlantas`(IN id INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`cpses_obkuweycr7`@`localhost` PROCEDURE `EliminarPropiedad`(IN id INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`cpses_obkuweycr7`@`localhost` PROCEDURE `EliminarSeguridad`(IN id INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`cpses_obkuweycr7`@`localhost` PROCEDURE `EliminarSeguridadPropiedad`(IN id INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`cpses_obkuweycr7`@`localhost` PROCEDURE `EliminarSobre`(IN id INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`cpses_obkuweycr7`@`localhost` PROCEDURE `EliminarTipoOperacion`(IN id INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`cpses_obkuweycr7`@`localhost` PROCEDURE `EliminarTipoPropiedad`(IN id INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`cpses_obkuweycr7`@`localhost` PROCEDURE `InsertBanios`(IN cant INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`cpses_obkuweycr7`@`localhost` PROCEDURE `InsertComfort`(IN tipo VARCHAR(100))
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`cpses_obkuweycr7`@`localhost` PROCEDURE `InsertComfortPropiedad`(IN idprop INT, IN idcomfort INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`cpses_obkuweycr7`@`localhost` PROCEDURE `InsertDistanciaMar`(IN dist VARCHAR(100))
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`cpses_obkuweycr7`@`localhost` PROCEDURE `InsertDormitorio`(IN cant INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`cpses_obkuweycr7`@`localhost` PROCEDURE `InsertEstado`(IN estado VARCHAR(100))
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`cpses_obkuweycr7`@`localhost` PROCEDURE `InsertGarage`(IN cant INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`cpses_obkuweycr7`@`localhost` PROCEDURE `InsertImagen`(IN idprop INT, IN foto VARCHAR(300))
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`cpses_obkuweycr7`@`localhost` PROCEDURE `InsertLocalidad`(IN iddepart INT, IN localidad VARCHAR(60))
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`cpses_obkuweycr7`@`localhost` PROCEDURE `InsertMensaje`(IN cont INT, IN tipo INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`cpses_obkuweycr7`@`localhost` PROCEDURE `InsertPlantas`(IN cant INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`cpses_obkuweycr7`@`localhost` PROCEDURE `InsertSeguridad`(IN tipo VARCHAR(100))
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`cpses_obkuweycr7`@`localhost` PROCEDURE `InsertSeguridadPropiedad`(IN idprop INT, IN idseguridad INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`cpses_obkuweycr7`@`localhost` PROCEDURE `InsertSobre`(IN sobre VARCHAR(60))
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`cpses_obkuweycr7`@`localhost` PROCEDURE `InsertTipoPropiedad`(IN tipoprop VARCHAR(60))
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`cpses_obkuweycr7`@`localhost` PROCEDURE `Login`(IN usu varchar(50),IN contra LONGTEXT)
BEGIN
	SELECT * FROM usuarios where usuario = usu and pass = contra;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`cpses_obkuweycr7`@`localhost` PROCEDURE `TraigoBaños`()
BEGIN
	Select * from banios;
END ;;
DELIMITER ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`cpses_obkuweycr7`@`localhost` PROCEDURE `TraigoComfort`()
BEGIN
	Select * from comfort;
END ;;
DELIMITER ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`cpses_obkuweycr7`@`localhost` PROCEDURE `TraigoComfortPropiedad`(IN prop_id int)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`cpses_obkuweycr7`@`localhost` PROCEDURE `TraigoDepartamentos`()
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`cpses_obkuweycr7`@`localhost` PROCEDURE `TraigoDistanciaMar`()
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`cpses_obkuweycr7`@`localhost` PROCEDURE `TraigoDormitorios`()
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`cpses_obkuweycr7`@`localhost` PROCEDURE `TraigoEstados`()
BEGIN
	Select * from estados;
END ;;
DELIMITER ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`cpses_obkuweycr7`@`localhost` PROCEDURE `TraigoGarage`()
BEGIN
	Select * from garage;
END ;;
DELIMITER ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`cpses_obkuweycr7`@`localhost` PROCEDURE `TraigoImagenes`(IN prop_id int)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`cpses_obkuweycr7`@`localhost` PROCEDURE `TraigoLocalidad`(IN Dep int)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`cpses_obkuweycr7`@`localhost` PROCEDURE `TraigoMensajes`()
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`cpses_obkuweycr7`@`localhost` PROCEDURE `TraigoPlantas`()
BEGIN
	Select * from plantas;
END ;;
DELIMITER ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`cpses_obkuweycr7`@`localhost` PROCEDURE `TraigoPropiedad`(IN prop int)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`cpses_obkuweycr7`@`localhost` PROCEDURE `TraigoPropiedades`()
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`cpses_obkuweycr7`@`localhost` PROCEDURE `TraigoPropiedadFiltro`(IN tipoop INT, IN tipoprop INT, IN dep INT, IN localid INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`cpses_obkuweycr7`@`localhost` PROCEDURE `TraigoSeguridad`()
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`cpses_obkuweycr7`@`localhost` PROCEDURE `TraigoSeguridadPropiedad`(IN prop_id int)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`cpses_obkuweycr7`@`localhost` PROCEDURE `TraigoSobre`()
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`cpses_obkuweycr7`@`localhost` PROCEDURE `TraigoTipoOperacion`()
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`cpses_obkuweycr7`@`localhost` PROCEDURE `TraigoTipoPropiedad`()
BEGIN
